...
export class changesInUsersEntity1613633135882 implements MigrationInterface {
    name = 'changesInUsersEntity1613633135882'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "timezone" character varying(100) NOT NULL DEFAULT 'Asia\Karachi'`);
