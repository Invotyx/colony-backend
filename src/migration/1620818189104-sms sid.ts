...
export class smsSid1620818189104 implements MigrationInterface {
    name = 'smsSid1620818189104'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "due_payments"."id" IS NULL`);
