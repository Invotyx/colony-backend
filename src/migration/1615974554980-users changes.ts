...
export class usersChanges1615974554980 implements MigrationInterface {
    name = 'usersChanges1615974554980'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "usedSmsCount" integer NOT NULL DEFAULT '0'`);
