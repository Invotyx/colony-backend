...
export class userEntityChanges1614169734120 implements MigrationInterface {
  name = 'userEntityChanges1614169734120';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "countryId" character varying(100)`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_cc0dc7234854a65964f1a268275" UNIQUE ("countryId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_ab40a6f0cd7d3ebfcce082131f"`);
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "UQ_cc0dc7234854a65964f1a268275"`,
    );
