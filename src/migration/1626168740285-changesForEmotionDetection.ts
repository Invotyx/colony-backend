...
export class changesForEmotionDetection1626168740285 implements MigrationInterface {
    name = 'changesForEmotionDetection1626168740285'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "anger" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "disgust" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "fear" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "joy" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "sadness" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "favorite_contacts" ADD CONSTRAINT "PK_05a33299d7fc459c795cf6936f5" PRIMARY KEY ("userId", "contactId")`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "sadness"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "joy"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "fear"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "disgust"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "anger"`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD "id" SERIAL NOT NULL`);
