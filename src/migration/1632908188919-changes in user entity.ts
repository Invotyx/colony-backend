...
export class changesInUserEntity1632908188919 implements MigrationInterface {
    name = 'changesInUserEntity1632908188919'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "require2fa" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD CONSTRAINT "PK_3bdef9df50d42c5ad544d1ce7e0" PRIMARY KEY ("userId", "contactId")`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "require2fa"`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP COLUMN "createdAt"`);
