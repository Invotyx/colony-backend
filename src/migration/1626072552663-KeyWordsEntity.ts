...
export class KeyWordsEntity1626072552663 implements MigrationInterface {
    name = 'KeyWordsEntity1626072552663'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "keywords" ("id" SERIAL NOT NULL, "keyword" character varying(20) NOT NULL, "message" character varying(500) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" integer, CONSTRAINT "PK_4aa660a7a585ed828da68f3c28e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "keywords" ADD CONSTRAINT "FK_5556ff65bfbc492ac6313405221" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_role" DROP CONSTRAINT "FK_dba55ed826ef26b5b22bd39409b"`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP CONSTRAINT "FK_ab40a6f0cd7d3ebfcce082131fd"`);
        await queryRunner.query(`ALTER TABLE "keywords" DROP CONSTRAINT "FK_5556ff65bfbc492ac6313405221"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "FK_eb6c00d59daf65d0bef9df3f823"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "FK_8ed56ad1ba2bd0dacfd6ba93166"`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP CONSTRAINT "FK_c39aaaf8c4d0008481197a31d31"`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" DROP CONSTRAINT "FK_9790665a8b08380db487e54b1be"`);
