...
export class ChangesInBroadcast1622628279292 implements MigrationInterface {
    name = 'ChangesInBroadcast1622628279292'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "broadcasts_contacts" ADD "smsSid" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "filters" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "broadcasts" ADD "status" character varying(20) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "broadcasts" DROP COLUMN "filters"`);
        await queryRunner.query(`ALTER TABLE "broadcasts_contacts" DROP COLUMN "smsSid"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "id" SERIAL NOT NULL`);
