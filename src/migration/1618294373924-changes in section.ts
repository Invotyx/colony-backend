...
export class changesInSection1618294373924 implements MigrationInterface {
    name = 'changesInSection1618294373924'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."sections_sectiontype_enum"`);
        await queryRunner.query(`ALTER TABLE "sections" ADD "sectionType" character varying(8) NOT NULL DEFAULT 'type1'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_eb6c00d59daf65d0bef9df3f82"`);
        await queryRunner.query(`ALTER TABLE "sections" DROP COLUMN "sectionType"`);
        await queryRunner.query(`CREATE TYPE "public"."sections_sectiontype_enum" AS ENUM('regular', 'faqs', 'packages', 'featuredIn', 'banner')`);
        await queryRunner.query(`ALTER TABLE "sections" ADD "sectionType" "sections_sectiontype_enum" NOT NULL DEFAULT 'regular'`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD CONSTRAINT "PK_3a91f61fd35430b525cea602d3c" PRIMARY KEY ("userId", "contactId", "id")`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "deletedAt"`);
