...
export class changesInPaymentMethods1613382533283
  implements MigrationInterface {
  name = 'changesInPaymentMethods1613382533283';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "name" character varying(15) NOT NULL`,
    );
    await queryRunner.query(
