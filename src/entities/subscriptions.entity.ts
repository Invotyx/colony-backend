...
export class SubscriptionsEntity {
  ...
  @ManyToOne(type=>PlansEntity, plan => plan.subscription,{eager:true,nullable:false})
  @JoinColumn({name:'planId'})
  public plan: PlansEntity;


  @Column({ type: 'enum', enum: collection_method, default: collection_method.charge_automatically })
