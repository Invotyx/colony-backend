...
export class presetTriggers1617282115239 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."preset_messages_trigger_enum" RENAME TO "preset_messages_trigger_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "preset_messages_trigger_enum" AS ENUM('onBoard', 'noResponse', 'welcome')`,
    );
    await queryRunner.query(
      `ALTER TABLE "preset_messages" ALTER COLUMN "trigger" TYPE "preset_messages_trigger_enum" USING "trigger"::"text"::"preset_messages_trigger_enum"`,
    );
    await queryRunner.query(`DROP TYPE "preset_messages_trigger_enum_old"`);
    await queryRunner.query(
      `COMMENT ON COLUMN "preset_messages"."trigger" IS NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "preset_messages_trigger_enum_old" AS ENUM('onBoard', 'noResponse')`,
    );
    await queryRunner.query(
      `ALTER TABLE "preset_messages" ALTER COLUMN "trigger" TYPE "preset_messages_trigger_enum_old" USING "trigger"::"text"::"preset_messages_trigger_enum_old"`,
    );
    await queryRunner.query(`DROP TYPE "preset_messages_trigger_enum"`);
    await queryRunner.query(
      `ALTER TYPE "preset_messages_trigger_enum_old" RENAME TO  "preset_messages_trigger_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2"`,
    );
