...
export class LatLongChangesInEntity1629299183294 implements MigrationInterface {
    name = 'LatLongChangesInEntity1629299183294'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contacts" ADD "lat" numeric`);
        await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "long"`);
        await queryRunner.query(`ALTER TABLE "contacts" ADD "long" numeric`);
