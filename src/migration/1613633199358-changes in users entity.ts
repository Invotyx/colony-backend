...
export class changesInUsersEntity1613633199358 implements MigrationInterface {
    name = 'changesInUsersEntity1613633199358'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "users"."timezone" IS NULL`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "timezone" SET DEFAULT 'Asia/Karachi'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_dba55ed826ef26b5b22bd39409"`);
        await queryRunner.query(`DROP INDEX "IDX_ab40a6f0cd7d3ebfcce082131f"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "timezone" SET DEFAULT 'AsiaKarachi'`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."timezone" IS NULL`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "user_role" ADD "meta" json`);
        await queryRunner.query(`CREATE INDEX "IDX_dba55ed826ef26b5b22bd39409" ON "user_role" ("roleId") `);
