...
export class changesInPlansAndSubscriptions1617262330873 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "countryId" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "country" ADD "active" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`COMMENT ON COLUMN "country"."active" IS 'Use only with plans.'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP COLUMN "countryId"`);
        await queryRunner.query(`ALTER TABLE "user_role" ADD "meta" json`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
