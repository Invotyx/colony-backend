...
export class PlansEntity {
  ...
  @ManyToOne(type=>ProductsEntity, product => product.plans,{eager:false,nullable:false})
  @JoinColumn({name:'productId'})
  public product: ProductsEntity;
  
  
  @OneToMany(type => SubscriptionsEntity, sub => sub.plan, { eager: false, cascade: true })
