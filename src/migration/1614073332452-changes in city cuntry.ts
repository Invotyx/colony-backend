...
export class changesInCityCuntry1614073332452 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "country" ADD "id" character varying(100) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "city" ADD "id" character varying(100) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "city" ADD "countryId" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "timezones" DROP CONSTRAINT "PK_589871db156cc7f92942334ab7e"`);
        await queryRunner.query(`ALTER TABLE "timezones" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "timezones" ADD "id" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "timezones" ADD CONSTRAINT "PK_589871db156cc7f92942334ab7e" PRIMARY KEY ("id")`);
