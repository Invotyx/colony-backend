...
export class minorSchemaChanges1612954721274 implements MigrationInterface {
  name = 'minorSchemaChanges1612954721274';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" RENAME COLUMN "plansId" TO "planId"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user_role" ADD "meta" json`);
    await queryRunner.query(
      `ALTER TABLE "subscriptions" RENAME COLUMN "planId" TO "plansId"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dba55ed826ef26b5b22bd39409" ON "user_role" ("roleId") `,
    );
