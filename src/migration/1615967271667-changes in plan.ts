...
export class changesInPlan1615967271667 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "phoneCount" DROP NOT NULL`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "plans"."phoneCount" IS NULL`);
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "phoneCount" SET DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "smsCount" DROP NOT NULL`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "plans"."smsCount" IS NULL`);
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "smsCount" SET DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_eb6c00d59daf65d0bef9df3f82"`);
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "smsCount" SET DEFAULT '1'`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "plans"."smsCount" IS NULL`);
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "smsCount" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "phoneCount" SET DEFAULT '1'`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "plans"."phoneCount" IS NULL`);
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "phoneCount" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2"`,
    );
