...
export class broadcostAddedToPivotTable1615546315332
  implements MigrationInterface {
  name = 'broadcostAddedToPivotTable1615546315332';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "preset_messages_trigger_enum" AS ENUM('onBoard', 'noResponse')`,
    );
    await queryRunner.query(
