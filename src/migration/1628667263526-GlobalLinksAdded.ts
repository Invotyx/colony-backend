...
export class GlobalLinksAdded1628667263526 implements MigrationInterface {
    name = 'GlobalLinksAdded1628667263526'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "global_links" ("shareableId" character varying NOT NULL, "link" character varying(255) NOT NULL, CONSTRAINT "PK_66fe860754fda3704ea18a5148a" PRIMARY KEY ("shareableId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`DROP TABLE "global_links"`);
        await queryRunner.query(`CREATE INDEX "IDX_cd5ab65b49ca427b863e357e62" ON "blocked_contacts" ("contactId") `);
        await queryRunner.query(`CREATE INDEX "IDX_65356109829654168a5f3a4df0" ON "blocked_contacts" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dba55ed826ef26b5b22bd39409" ON "user_role" ("roleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ab40a6f0cd7d3ebfcce082131f" ON "user_role" ("userId") `);
