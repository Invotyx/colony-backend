...
export class changesInPivotTableContacts1614852723560
  implements MigrationInterface {
  name = 'changesInPivotTableContacts1614852723560';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "influencer_contacts" DROP COLUMN "urlMapper"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "urlMapper" character varying(100)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_dba55ed826ef26b5b22bd39409"`);
    await queryRunner.query(`DROP INDEX "IDX_ab40a6f0cd7d3ebfcce082131f"`);
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "urlMapper"`);
    await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
    await queryRunner.query(`ALTER TABLE "user_role" ADD "meta" json`);
    await queryRunner.query(
      `ALTER TABLE "influencer_contacts" ADD "urlMapper" character varying(100)`,
    );
    await queryRunner.query(
