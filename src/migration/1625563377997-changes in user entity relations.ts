...
export class changesInUserEntityRelations1625563377997 implements MigrationInterface {
    name = 'changesInUserEntityRelations1625563377997'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "users"."cityId" IS NULL`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "REL_3785318df310caf8cb8e1e37d8"`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."countryId" IS NULL`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "REL_cc0dc7234854a65964f1a26827"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_8ed56ad1ba2bd0dacfd6ba9316"`);
        await queryRunner.query(`DROP INDEX "IDX_eb6c00d59daf65d0bef9df3f82"`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "REL_cc0dc7234854a65964f1a26827" UNIQUE ("countryId")`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."countryId" IS NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "REL_3785318df310caf8cb8e1e37d8" UNIQUE ("cityId")`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."cityId" IS NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_cc0dc7234854a65964f1a268275" FOREIGN KEY ("countryId") REFERENCES "country"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_3785318df310caf8cb8e1e37d85" FOREIGN KEY ("cityId") REFERENCES "city"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "phones" ALTER COLUMN "sid" SET DEFAULT NULL`);
