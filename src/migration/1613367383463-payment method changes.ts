...
export class paymentMethodChanges1613367383463 implements MigrationInterface {
  name = 'paymentMethodChanges1613367383463';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "type" character varying(15)`,
    );
    await queryRunner.query(
