...
export class CityEntityChanges1625461688165 implements MigrationInterface {
    name = 'CityEntityChanges1625461688165'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "city" ADD "lat" numeric`);
        await queryRunner.query(`ALTER TABLE "city" DROP COLUMN "long"`);
        await queryRunner.query(`ALTER TABLE "city" ADD "long" numeric`);
