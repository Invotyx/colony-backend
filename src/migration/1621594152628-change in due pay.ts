...
export class changeInDuePay1621594152628 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "due_payments" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "due_payments" DROP CONSTRAINT "PK_323af4cf3922a5b7bfd9789a516"`);
        await queryRunner.query(`ALTER TABLE "due_payments" DROP CONSTRAINT "UQ_323af4cf3922a5b7bfd9789a516"`);
        await queryRunner.query(`ALTER TABLE "due_payments" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD CONSTRAINT "PK_323af4cf3922a5b7bfd9789a516" PRIMARY KEY ("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "due_payments" DROP CONSTRAINT "PK_323af4cf3922a5b7bfd9789a516"`);
        await queryRunner.query(`ALTER TABLE "due_payments" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD "id" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD CONSTRAINT "UQ_323af4cf3922a5b7bfd9789a516" UNIQUE ("id")`);
        await queryRunner.query(`ALTER TABLE "due_payments" ADD CONSTRAINT "PK_323af4cf3922a5b7bfd9789a516" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD CONSTRAINT "PK_3a91f61fd35430b525cea602d3c" PRIMARY KEY ("userId", "contactId", "id")`);
        await queryRunner.query(`ALTER TABLE "due_payments" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "due_payments" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "createdAt"`);
