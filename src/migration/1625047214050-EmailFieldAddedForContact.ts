...
export class EmailFieldAddedForContact1625047214050 implements MigrationInterface {
    name = 'EmailFieldAddedForContact1625047214050'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contacts" ADD "email" character varying(100)`);
