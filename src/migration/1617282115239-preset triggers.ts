...
export class presetTriggers1617282115239 implements MigrationInterface {
    name = 'presetTriggers1617282115239'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "public"."preset_messages_trigger_enum" RENAME TO "preset_messages_trigger_enum_old"`);
        await queryRunner.query(`CREATE TYPE "preset_messages_trigger_enum" AS ENUM('onBoard', 'noResponse', 'welcome')`);
        await queryRunner.query(`ALTER TABLE "preset_messages" ALTER COLUMN "trigger" TYPE "preset_messages_trigger_enum" USING "trigger"::"text"::"preset_messages_trigger_enum"`);
        await queryRunner.query(`DROP TYPE "preset_messages_trigger_enum_old"`);
        await queryRunner.query(`COMMENT ON COLUMN "preset_messages"."trigger" IS NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_eb6c00d59daf65d0bef9df3f82"`);
        await queryRunner.query(`COMMENT ON COLUMN "preset_messages"."trigger" IS NULL`);
        await queryRunner.query(`CREATE TYPE "preset_messages_trigger_enum_old" AS ENUM('onBoard', 'noResponse')`);
        await queryRunner.query(`ALTER TABLE "preset_messages" ALTER COLUMN "trigger" TYPE "preset_messages_trigger_enum_old" USING "trigger"::"text"::"preset_messages_trigger_enum_old"`);
        await queryRunner.query(`DROP TYPE "preset_messages_trigger_enum"`);
        await queryRunner.query(`ALTER TYPE "preset_messages_trigger_enum_old" RENAME TO  "preset_messages_trigger_enum"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD CONSTRAINT "PK_3a91f61fd35430b525cea602d3c" PRIMARY KEY ("userId", "contactId", "id")`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "deletedAt"`);
