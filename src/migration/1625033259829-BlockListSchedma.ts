...
export class BlockListSchedma1625033259829 implements MigrationInterface {
    name = 'BlockListSchedma1625033259829'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "blocked_contacts" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "contactId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_076efedc225dc94397614eaaa4c" PRIMARY KEY ("id", "userId", "contactId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" DROP CONSTRAINT "PK_3bdef9df50d42c5ad544d1ce7e0"`);
        await queryRunner.query(`ALTER TABLE "blocked_contacts" ADD CONSTRAINT "PK_076efedc225dc94397614eaaa4c" PRIMARY KEY ("id", "userId", "contactId")`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "favorite_contacts" ADD "id" SERIAL NOT NULL`);
