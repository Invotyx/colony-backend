...
export class changesInPlan1613456938000 implements MigrationInterface {
  name = 'changesInPlan1613456938000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "plans_plantype_enum" AS ENUM('bundle', 'phoneOnly')`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "planType" "plans_plantype_enum" NOT NULL DEFAULT 'bundle'`,
    );
    await queryRunner.query(
