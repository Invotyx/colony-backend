...
export class changesInPivotTableContacts1614852723560 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contacts" ADD "urlMapper" character varying(100)`);
