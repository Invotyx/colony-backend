...
export class paymentHistory1620632176224 implements MigrationInterface {
    name = 'paymentHistory1620632176224'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "smsCost"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "phoneCost"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "subscriberCost"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "packageCost"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "thresholdSmsCount"`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "cost" numeric NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "costType" character varying(20) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "chargeId" character varying(100) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD CONSTRAINT "PK_3a91f61fd35430b525cea602d3c" PRIMARY KEY ("userId", "contactId", "id")`);
        await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "chargeId"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "costType"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "cost"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" DROP CONSTRAINT "PK_3a91f61fd35430b525cea602d3c"`);
        ...
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "influencer_contacts" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "thresholdSmsCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "packageCost" numeric NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "subscriberCost" numeric NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "phoneCost" numeric NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "smsCost" numeric NOT NULL DEFAULT '0'`);
