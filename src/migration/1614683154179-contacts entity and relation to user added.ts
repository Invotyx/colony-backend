...
export class contactsEntityAndRelationToUserAdded1614683154179 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "influencer_contacts" ("userId" integer NOT NULL, "contactId" integer NOT NULL, CONSTRAINT "PK_45170f07127ff6f89c97d2d64b2" PRIMARY KEY ("userId", "contactId"))`);
        await queryRunner.query(`CREATE TYPE "contacts_gender_enum" AS ENUM('male', 'female', 'non_binary')`);
        await queryRunner.query(`CREATE TABLE "contacts" ("id" SERIAL NOT NULL, "name" character varying(100), "phoneNumber" character varying(20) NOT NULL, "isComplete" boolean NOT NULL DEFAULT false, "gender" "contacts_gender_enum", "dob" TIMESTAMP, "state" character varying(100), "timezone" character varying(100), "isVerified" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "countryId" character varying(100), "cityId" character varying(100), CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
