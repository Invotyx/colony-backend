...
export class ChangesForMeta1612444783935 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pages" ADD "metaDescription" character varying(300)`);
        await queryRunner.query(`ALTER TABLE "pages" ADD "metaTags" character varying(300)`);
        await queryRunner.query(`CREATE TYPE "sections_sectiontype_enum" AS ENUM('regular', 'faqs', 'packages', 'featuredIn', 'clients')`);
