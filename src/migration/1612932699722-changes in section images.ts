...
export class changesInSectionImages1612932699722 implements MigrationInterface {
    name = 'changesInSectionImages1612932699722'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "images" ADD "title" character varying(100)`);
