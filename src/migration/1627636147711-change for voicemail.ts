...
export class changeForVoicemail1627636147711 implements MigrationInterface {
    name = 'changeForVoicemail1627636147711'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "voiceUrl" character varying(1000) DEFAULT null`);
