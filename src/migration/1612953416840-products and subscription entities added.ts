...
export class productsAndSubscriptionEntitiesAdded1612953416840
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment_methods" ("id" character varying(100) NOT NULL, "last4_card" character varying(4) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" integer NOT NULL, CONSTRAINT "UQ_34f9b8c6dfb4ac3559f7e2820d1" UNIQUE ("id"), CONSTRAINT "PK_34f9b8c6dfb4ac3559f7e2820d1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "products" ("id" character varying(100) NOT NULL, "name" character varying(200) NOT NULL, "description" character varying(300) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_0806c755e0aca124e67c0cf6d7d" UNIQUE ("id"), CONSTRAINT "UQ_4c9fb58de893725258746385e16" UNIQUE ("name"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "subscriptions_collection_method_enum" AS ENUM('0', '1')`,
    );
    await queryRunner.query(
      `CREATE TABLE "subscriptions" ("id" character varying(100) NOT NULL, "collection_method" "subscriptions_collection_method_enum" NOT NULL DEFAULT '0', "cancelled" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" integer NOT NULL, "plansId" character varying(100) NOT NULL, CONSTRAINT "UQ_a87248d73155605cf782be9ee5e" UNIQUE ("id"), CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "plans_interval_enum" AS ENUM('0', '1')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "customerId" character varying(100)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_41cc0b0f511c1d6114694af7dda" FOREIGN KEY ("plansId") REFERENCES "plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_41cc0b0f511c1d6114694af7dda"`,
    );
    await queryRunner.query(
