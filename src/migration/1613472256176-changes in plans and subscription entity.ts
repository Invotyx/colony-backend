...
export class changesInPlansAndSubscriptionEntity1613472256176
  implements MigrationInterface {
  name = 'changesInPlansAndSubscriptionEntity1613472256176';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "paymentType" character varying(20) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "recurring" character varying(20) NOT NULL`,
    );
    await queryRunner.query(
