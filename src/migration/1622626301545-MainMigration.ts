...
export class MainMigration1622626301545 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "due_payments" ("id" SERIAL NOT NULL, "cost" numeric NOT NULL DEFAULT '0', "costType" character varying(20) NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "PK_323af4cf3922a5b7bfd9789a516" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "conversation_messages" ("id" SERIAL NOT NULL, "sms" character varying(1000) NOT NULL, "status" character varying(10) NOT NULL, "type" character varying(20) NOT NULL, "sid" character varying(100), "receivedAt" TIMESTAMP DEFAULT null, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "conversationsId" integer, CONSTRAINT "PK_113248f25c4c0a7c179b3f5a609" PRIMARY KEY ("id"))`);
