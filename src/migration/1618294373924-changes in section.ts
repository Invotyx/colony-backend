...
export class changesInSection1618294373924 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sections" ADD "sectionType" character varying(8) NOT NULL DEFAULT 'type1'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "sections" DROP COLUMN "sectionType"`);
    await queryRunner.query(
      `CREATE TYPE "public"."sections_sectiontype_enum" AS ENUM('regular', 'faqs', 'packages', 'featuredIn', 'banner')`,
    );
    await queryRunner.query(
