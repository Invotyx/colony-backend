...
export class broadcostAddedToPivotTable1615545709336
  implements MigrationInterface {
  name = 'broadcostAddedToPivotTable1615545709336';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "broadcasts_contacts" ADD "contactId" integer`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "broadcasts_contacts" DROP COLUMN "contactId"`,
    );
    await queryRunner.query(`ALTER TABLE "user_role" DROP COLUMN "meta"`);
    await queryRunner.query(
      `ALTER TABLE "influencer_contacts" DROP COLUMN "deletedAt"`,
